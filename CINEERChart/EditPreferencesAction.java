...
-----------------------------------------------------------------------
     Aaron      1.0.0    EditPreferencesActon
     Aaron      1.0.1    Add Rates Filter Criteria
     Aaron      1.0.2    cater for no maximization page
***********************************************************************/
    ...
    public void processAction(
        ...
        if (cmd.equals(Constants.UPDATE)){
            ...
            try {
                ...
                portletURLImpl.setParameter("struts_action", "/CINEERChart/frmConfig");
